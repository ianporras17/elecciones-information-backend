...
exports.CreateRoomDto = exports.RoomStatus = void 0;
...
class CreateRoomDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, description: { required: false, type: () => String }, status: { required: true, enum: require("./create-room.dto").RoomStatus } };
    }
}
